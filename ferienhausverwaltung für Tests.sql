...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 25. Feb 2025 um 13:38
...
WHERE LOWER(RegionName) LIKE LOWER(CONCAT('%', p_location_name, '%'))
    ...
    AND
    (
        -- 3) DATE FILTER (Availability):
        -- If p_startDatum or p_endDatum is NULL, skip filter.
        -- Otherwise, exclude houses booked in the given range.
        
        p_startDatum IS NULL 
        OR p_endDatum IS NULL
        OR h.HausID NOT IN (
            SELECT b.HausID 
            FROM buchung b
            WHERE (b.Startdatum <= p_endDatum AND b.Enddatum >= p_startDatum)
        )
    );
END$$
...
(28, 'user', 'user3@pw123.com', '+4917649825448', 3, '$2y$10$hMhv..BgDtIEJGGsw3ThX.LbNKxZKqwylr1XN5Kjaj8Q1KS.Tp6VK'),
(29, 'user', 'user4@pw123.com', '+4917649825448', 3, '$2y$10$053AB9YD80AyHmtyj/TsK.FkvdnT0DwS94ZsNVSCP8sD54McCiurC'),
(30, 'user', 'user1@pw123.com', '+4917649825448', 3, '$2y$10$OS.hO99kfutfVh2rZxEIbewO5aRhdIB5Cq9kDJTwd8lqFJ22fHTO2');
...
--
ALTER TABLE `buchung_aktivitaet`
  MODIFY `BuchungAktivitaetID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;

--
-- AUTO_INCREMENT für Tabelle `eigentümer`
--
ALTER TABLE `eigentümer`
  MODIFY `EigentümerID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `haus`
  MODIFY `HausID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT für Tabelle `mietvertrag`
--
ALTER TABLE `mietvertrag`
  MODIFY `VertragID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT für Tabelle `mängelanzeige`
--
ALTER TABLE `mängelanzeige`
  MODIFY `MangelID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT für Tabelle `nutzer`
--
ALTER TABLE `nutzer`
  MODIFY `NutzerID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `rechnung`
  MODIFY `RechnungID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
